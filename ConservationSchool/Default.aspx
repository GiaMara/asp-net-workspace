                            ...
                            <div style="background: url(images/rb.gif) no-repeat 100% 100%; padding-right: 50px;">
                                <div id="c">
                                    <div style="padding: 30px;">
                                        ...
                                        <asp:TextBox ID="studentID" runat="server" /> &nbsp;<asp:Button ID="Button1" runat="server" Text="Returning Students" />&nbsp;<asp:Literal ID="validateMessage" runat="server" /> &nbsp; <asp:RequiredFieldValidator ID="idValidator" runat="server" ErrorMessage="**You must enter your student ID**" ControlToValidate="studentID" /> 
                                        </form>
                                    </div>
                                </div>
                            </div>
